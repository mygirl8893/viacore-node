...
/**
 * Will return the path and viacore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'viacore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'viacore-node.json'))
  };
}
