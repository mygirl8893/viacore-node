...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `viacore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ viacore-node add wallet-service');
      console.log('    $ viacore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ viacore-node remove wallet-service');
      console.log('    $ viacore-node remove insight-api');
      console.log();
    });
